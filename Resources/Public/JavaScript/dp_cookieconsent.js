...
`,w=`<button class="cc-btn cc-allow-all cc-w-100" tabindex="2">\r
    {{allow-all}}\r
</button>\r
...
`,C=`<button class="cc-btn cc-deny" tabindex="2">\r
    {{deny}}\r
</button>\r
...
\r
        <div class="cc-form-switch">\r
            <input class="dp--check-box" id="dp--cookie-{{group-lower}}" tabindex="1" type="checkbox" name="" value="">\r
